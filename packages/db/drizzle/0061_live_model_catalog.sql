...
VALUES
  ...
  ('default', 'xai/grok-4.20-reasoning-beta', 'xai', 'Grok 4.20 Beta', 'language'),
  ...
  ('default', 'xai/grok-4.20-non-reasoning-beta', 'xai', 'Grok 4.20 Beta NR', 'language'),
...
VALUES
  ...
  ('default', 'xai/grok-4.20-reasoning-beta', 'main', true, false),
  ...
  ('default', 'xai/grok-4.20-non-reasoning-beta', 'fast', true, false),
