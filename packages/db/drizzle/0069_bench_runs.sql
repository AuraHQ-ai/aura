...
CREATE INDEX "bench_runs_run_id_idx" ON "bench_runs" USING btree ("run_id");--> statement-breakpoint
CREATE INDEX "bench_runs_dataset_category_idx" ON "bench_runs" USING btree ("dataset","category","score_type","created_at");
