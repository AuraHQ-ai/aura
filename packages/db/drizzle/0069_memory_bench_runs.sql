...
CREATE INDEX "bench_runs_lookup_idx" ON "bench_runs" USING btree ("workspace_id","dataset","category","score_type","created_at");--> statement-breakpoint
CREATE INDEX "bench_runs_run_id_idx" ON "bench_runs" USING btree ("run_id");
