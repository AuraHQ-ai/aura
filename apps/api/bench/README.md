...
Latest baseline: `772e8fb` · 2026-06-02 11:04 UTC.

### `longmemeval/medium`

- scope: `longmemeval/medium` · corpus `b178d604c01a` · cases `a0018f6e9f0fccb4` · runtime 138m27s · cost $21.71
- models: extraction `anthropic/claude-haiku-4.5` · answerer `anthropic/claude-opus-4.8` · judge `anthropic/claude-opus-4.6`
- overall: QA 65% · recall@15 93% (n=179)
