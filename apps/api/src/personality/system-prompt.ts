...
/** @internal — wraps bench-safe formatter with production tone hint */
function formatMemories(memories: Memory[]): string {
  const body = formatMemoriesForPrompt(memories);
  if (!body) return "";
  return `${body}\n\nDon't tell the user you're "checking your memories."`;
}
