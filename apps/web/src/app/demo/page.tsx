  ...
  },
  {
    ...
    content: [
      { type: "text", text: "On it." },
      {
        ...
        name: "list_channels",
        status: "ok",
        detail: "{ \"limit\": 200 }\n→ 42 channels returned",
      },
      {
        type: "tool_call",
        name: "read_channel_history",
        status: "ok",
        detail: "{ \"channel\": \"general\", \"limit\": 50 }\n→ 50 messages fetched",
      },
      {
        type: "text",
      ...
      },
      {
        ...
        status: "ok",
        detail: "{ \"channel\": \"general\", \"message\": \"Weekly top 5...\" }\n→ Message sent",
      },
    ...
    content: [
      {
        ...
        name: "read_channel_history",
        status: "ok",
        detail: "Fetching 30-day history across all channels...",
      },
      {
        type: "tool_call",
        name: "create_canvas",
        status: "ok",
        detail: "{ \"title\": \"Monthly Channel Volume Report\" }\n→ Canvas F0A1B2C3D created",
      },
      {
        type: "text",
