    ...
    <div className="flex h-full flex-col">
      <div className="flex h-14 items-center border-b px-4">
        <Link href="/" className="flex items-center gap-2 font-semibold text-sm" onClick={onClose}>
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="16" viewBox="0 0 102 90" fill="none">
...
export function Sidebar() {
  return (
    <aside className="hidden md:flex w-60 shrink-0 border-r" style={{ background: "var(--sidebar-bg)" }}>
      <NavContent />
    </aside>
  );
}
    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <div className="fixed inset-y-0 left-0 w-60 border-r bg-background shadow-lg">
