...
Current codebase (as of `65b1205`, scope `locomo/medium`): **QA 14%** · **recall@15 55%** across 150 questions. Full breakdown + history in [apps/api/bench/README.md](apps/api/bench/README.md).
