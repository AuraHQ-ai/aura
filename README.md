...
Current codebase (as of `5c5b88a`, scope `locomo+longmemeval/medium`): **QA 36%** · **recall@15 77%** across 22 questions. Full breakdown + history in [apps/api/bench/README.md](apps/api/bench/README.md).
