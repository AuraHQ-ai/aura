...
We may update these Terms. We will notify workspace admins via Slack message before material changes take effect. Continued use after notice constitutes acceptance.
